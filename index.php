...
$COURSE = [
 ...
 2 => ['date'=>'Tue · Jun 16','title'=>'Tools & Interoperability — "10x Agents"','live'=>true,
   ...
   'links'=>[
     ...
     ['🎧 Unit 2 podcast + whitepaper (Kaggle forum)','https://www.kaggle.com/competitions/5-day-ai-agents-intensive-vibecoding-course-with-google/discussion'],
     ['📺 Livestream + Day-1 recording (Kaggle YouTube)','https://www.youtube.com/@kaggle'],
   ]],
