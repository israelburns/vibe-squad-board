...
$COURSE = [
 ...
 2 => ['date'=>'Tue · Jun 16','title'=>'Tools & Interoperability — "10x Agents"','live'=>false,
   'blurb'=>'Supercharge agents with API connections, code execution, and agent-to-agent communication. Multi-agent systems that call real tools.',
   'links'=>[]],
